...
import useLocalStorage from 'react-use-localstorage'
 ...
 export const NewUser = () => {
   ...
   const validate = Yup.object({
     ...
     //courses:Yup.string()
     //.min(3, 'Must register 3 courses or more')
     //.required('Select Courses')
   })
        ...
        {formik => (
          ...
          <div className='row justify-content-center'>
           ...
           <h1 className='my-4 font-weight-bold-display-4'>Sign up</h1>
             ...
             <div className='col'>
               <div className='sc-btn-box form-control  '>
             <span className='sc-btn' data-toggle="modal" data-target="#exampleModal" >Select Courses</span>
             </div>
             </div>
             </div>
             <div className='form-row'>
             ...
             <button className='btn mt-3 my-btn col-6' type='submit'>Register</button>
             </div>
